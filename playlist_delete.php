...
$redirect_url = FREETUBESITE_URL . '/' . $_SESSION['USERNAME'] . '/playlist/' . $page;
...
if (isset($_GET['action']))
{
    if ($_GET['action'] == "vdo_del" )
    {
        ...
        if ($playlist_info)
        {
	        ...
	        $redirect_url = FREETUBESITE_URL . '/' . $_SESSION['USERNAME'] . '/playlist/' . $playlist_info['playlist_name'] . '/' . $page;
        }
    }
