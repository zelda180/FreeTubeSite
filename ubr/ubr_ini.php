...
//	Revision: 2.5
//	Date: 10:26 PM Tuesday, January 13, 2009
...
$TEMP_DIR                    =  FREETUBESITE_DIR . '/templates_c/';             // *ATTENTION : The $TEMP_DIR value MUST be duplicated in the "ubr_upload.pl" file
$DATA_DELIMITER              = '<=>';                        // *ATTENTION : The $DATA_DELIMITER value MUST be duplicated in the "ubr_upload.pl" file

$UBER_VERSION                = '6.6';                        // Version of Uber-Uploader
$PATH_TO_UPLOAD_SCRIPT       = FREETUBESITE_URL . '/cgi-bin/ubr_upload.pl';     // Path info
$PATH_TO_LINK_SCRIPT         = FREETUBESITE_URL . '/ubr/ubr_link_upload.php';        // Path info
$PATH_TO_SET_PROGRESS_SCRIPT = FREETUBESITE_URL . '/ubr/ubr_set_progress.php';       // Path info
$PATH_TO_GET_PROGRESS_SCRIPT = FREETUBESITE_URL . '/ubr/ubr_get_progress.php';       // Path info
$PATH_TO_JS_SCRIPT           = FREETUBESITE_URL . '/ubr/ubr_file_upload.js';         // Path info
$PATH_TO_JQUERY              = FREETUBESITE_URL . '/ubr/jquery-1.3.1.min.js';        // Path Info
$PATH_TO_CSS_FILE            = FREETUBESITE_URL . '/ubr/ubr.css';                    // Path info
$DEFAULT_CONFIG              = FREETUBESITE_DIR . '/ubr/ubr_default_config.php';     // Path info
$MULTI_CONFIGS_ENABLED       = 0;                            // Enable/Disable multi config files
$CGI_UPLOAD_HOOK             = 0;                            // Use the CGI hook file to get upload status
$GET_PROGRESS_SPEED          = 5000;                         // CAUTION ! How frequent the web server is poled for upload status. 5000=5 seconds, 1000=1 second, 500=0.5 seconds, 250=0.25 seconds. etc.
